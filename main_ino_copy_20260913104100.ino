...
// Web Server Setup
WebServer server(80);
const char* ssid = "OPPO A55";        // Your Wi-Fi Name
const char* password = "9977022400"; // Your Wi-Fi Password
...
void setup() {
  // SET TO 9600 TO MATCH YOUR IDE SERIAL MONITOR
  Serial.begin(9600);
  delay(1000);
  Serial.println("\n--- Starting ESP32-C3 Health Monitor ---");

  // 1. Configure ADC Attenuation for full 0-3.3V range
  analogSetPinAttenuation(ECG_ANALOG_PIN, ADC_11db);

  // 2. Initialize Custom I2C Bus for ESP32-C3
